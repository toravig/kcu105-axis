...
proc init_gui { IPINST } {
	...
	set AXIS_TKEEP_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name AXIS_TKEEP_WIDTH -widget radioGroup]
	set AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name AXIS_TDATA_WIDTH -widget radioGroup]
	set SEQ_END_CNT_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name SEQ_END_CNT_WIDTH -widget radioGroup]
	set CNT_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name CNT_WIDTH -widget radioGroup]
}
