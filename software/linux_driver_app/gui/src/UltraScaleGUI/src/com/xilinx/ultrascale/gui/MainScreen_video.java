 ...
 * @author Mobigesture
 */
public class MainScreen_video extends javax.swing.JFrame {
...
//                 PcieEndStatuspanel.revalidate();
    ...
    private void initComponents() {
        ...
        txVidPanel = new javax.swing.JPanel();
        rxVidPanel = new javax.swing.JPanel();
        ...
        mincoeff.setModel(new javax.swing.SpinnerNumberModel(0, 0, 255, 1));
        ...
        maxcoeff.setModel(new javax.swing.SpinnerNumberModel(255, 0, 255, 1));
            ...
            .addGroup(topVidpanelLayout.createSequentialGroup()
                ...
                .addGroup(topVidpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(topVidpanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(invertcheckbox, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        topVidpanelLayout.setVerticalGroup(
            ...
            .addGroup(topVidpanelLayout.createSequentialGroup()
                ...
                .addGroup(topVidpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(mincoeff, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        ...
        videosPanel.setMinimumSize(new java.awt.Dimension(1500, 727));

        txVidPanel.setMinimumSize(new java.awt.Dimension(400, 406));
        txVidPanel.setPreferredSize(new java.awt.Dimension(400, 406));

        javax.swing.GroupLayout txVidPanelLayout = new javax.swing.GroupLayout(txVidPanel);
        txVidPanel.setLayout(txVidPanelLayout);
        txVidPanelLayout.setHorizontalGroup(
            txVidPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 738, Short.MAX_VALUE)
        );
        txVidPanelLayout.setVerticalGroup(
            txVidPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );

        rxVidPanel.setMinimumSize(new java.awt.Dimension(400, 406));
        rxVidPanel.setPreferredSize(new java.awt.Dimension(400, 0));

        javax.swing.GroupLayout rxVidPanelLayout = new javax.swing.GroupLayout(rxVidPanel);
        rxVidPanel.setLayout(rxVidPanelLayout);
        rxVidPanelLayout.setHorizontalGroup(
            rxVidPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 738, Short.MAX_VALUE)
        );
        rxVidPanelLayout.setVerticalGroup(
            rxVidPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        videosPanelLayout.setHorizontalGroup(
            ...
            .addGroup(videosPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txVidPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 738, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(rxVidPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 738, Short.MAX_VALUE))
        );
        videosPanelLayout.setVerticalGroup(
            videosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(videosPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(videosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(rxVidPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 673, Short.MAX_VALUE)
                    .addComponent(txVidPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 673, Short.MAX_VALUE))
                .addContainerGap(42, Short.MAX_VALUE))
        );

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
        setTitle("Kintex UltraScale PCIe Design Control & Monitoring GUI");
        setMinimumSize(new java.awt.Dimension(1195, 665));
        setResizable(false);
        addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowClosing(java.awt.event.WindowEvent evt) {
                MainScreen_video.this.windowClosing(evt);
            }
        });
        ...
        phy0icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/xilinx/ultrascale/gui/green.png"))); // NOI18N
        ...
        phy1icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/xilinx/ultrascale/gui/green.png"))); // NOI18N
        ...
        sysmonpanelLayout.setHorizontalGroup(
            ...
            .addGroup(sysmonpanelLayout.createSequentialGroup()
                ...
                .addGap(266, 349, Short.MAX_VALUE))
            .addGroup(sysmonpanelLayout.createSequentialGroup()
                .addContainerGap()
...
//            ddrTxTextField.setText("0.000");
    ...
    private void resetloadDelay() {
        // reset the load delay to 0. this val is to ignore first few iterations.
        loadDelay = 0;
    }
...
//            ddrTxTextField.setText("0.000");
    ...
    private void jbuttonEngStart2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonEngStart2ActionPerformed
        ...
        if (jbuttonEngStart2.getText().equalsIgnoreCase("Start")) {
            ...
            int size = Integer.parseInt(sizeTextField2.getText());
            di.startTest(0, eth1TestMode, size);
...
//            ddrTxTextField.setText("0.000");
    ...
    //Canvas txCanvas;
    //MediaPlayerFactory txMediaPlayerFactory;
    EmbeddedMediaPlayerComponent txMediaPlayer;

    //Canvas rxCanvas;
    //MediaPlayerFactory rxMediaPlayerFactory;
    EmbeddedMediaPlayerComponent rxMediaPlayer;

    private void sysout(String str) {
//        System.out.println("" + str);
    }
    int videoWidth = 800, VideoHeight = 500;
    GraphicsDevice screen;
    String aspectRatio = "16:10";
...
//        videoFrame.getContentPane().setBackground(Color.BLACK);
        ...
        frame1.setBounds(videoFrame.getBounds().x + 5, videoFrame.getBounds().y + 50,
                480, 270);
        ...
        frame2.setBounds(videoFrame.getBounds().x + 490, videoFrame.getBounds().y + 50,
                480, 270);
...
//            }
    ...
    private void enablePlayButton() {
        ...
        di.ResetVDMA(0, 7, Integer.parseInt(mincoeff.getValue().toString()), Integer.parseInt(maxcoeff.getValue().toString()), invertcheckbox.isSelected() ? 1 : 0, 7680);
        videoplayButton.setText("Start");
    ...
    private void videoPauseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_videoPauseButtonActionPerformed
        ...
        if (videoPauseButton.getText().equalsIgnoreCase("Pause")) {
            ...
            txMediaPlayer.getMediaPlayer().pause();

//            BGWorker worker = new BGWorker("./util/run_vlc.sh" + " pause " + pathFied.getText());
//            worker.execute();
        } else {
            videoPauseButton.setText("Pause");
            txMediaPlayer.getMediaPlayer().play();
...
//            worker.execute();
        ...
        try {
            ...
            Logger.getLogger(MainScreen_video.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void loadAllGraphs() {
        ...
        if (screenMode == 3 || screenMode == 4) {
            String[] labels0 = {"S2C PCIe", "AXI Writes Data Path 0", "AXI Writes Data Path 1"};
            String[] labels2 = {"C2S PCIe", "AXI Reads Data Path 0", "AXI Reads Data Path 1"};
        ...
        if (screenMode == 7) {
            chartTop.upperBounds(35);
            chartBottom.upperBounds(35);
        }
        if (screenMode == 2) {
...
//        ddr4panel.setVisible(false);
    ...
    public static MainScreen_video getInstance() {
//        if (ms == null) 
        {
            ms = new MainScreen_video();
        }
        return ms;
    }
...
//        ddrRxTextField.setText(String.format("%2.3f", trnStats.RBC_DDR));
        ...
        if (ethTestStarted1) {
            axiTxTextField2.setText(String.format("%2.3f", trnStats.WBC_APM));
            axiRxTextField2.setText(String.format("%2.3f", trnStats.RBC_APM));
            wbcApmDP1 = trnStats.WBC_APM;
            rbcApmDP1 = trnStats.RBC_APM;
        }
        if (ethTestStarted0 || ethTestStarted1) {
            // update chart
    ...
    String[] VLC_ARGS = {
        ...
        "--clone-count=1",
        "--clone-vout-list=fb:xcb_xv"};
    static MainScreen_video ms;
    DriverInfo di;
...
//        {"MRPS(Bytes)", "512"}           
    ...
    private javax.swing.JPanel rxVidPanel;
    ...
    private javax.swing.JPanel txVidPanel;
