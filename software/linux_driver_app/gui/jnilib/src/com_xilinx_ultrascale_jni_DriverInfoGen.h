 ...
 * Signature: (III)I
 */
JNIEXPORT jint JNICALL Java_com_xilinx_ultrascale_jni_DriverInfoGen_startTest1
  (JNIEnv *, jobject, jint, jint, jint);
 ...
 * Signature: (III)I
 */
JNIEXPORT jint JNICALL Java_com_xilinx_ultrascale_jni_DriverInfoGen_stopTest1
  (JNIEnv *, jobject, jint, jint, jint);
